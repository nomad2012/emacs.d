(custom-set-variables
 ...
 '(ecb-excluded-directories-regexps '("^\\(CVS\\|\\.[^a-zA-Z]*\\)$"))
 '(ecb-layout-name "left1")
 '(ecb-options-version "2.50")
 '(ecb-primary-secondary-mouse-buttons 'mouse-1--mouse-2)
 '(ecb-source-path '(("c:" "c:") ("/" "/")))
 '(ecb-tip-of-the-day nil)
 '(ecb-toggle-layout-sequence '("left1" "top1"))
 '(ecb-version-check nil)
 '(ediff-split-window-function 'split-window-horizontally)
 '(ediff-window-setup-function 'ediff-setup-windows-plain)
 '(elfeed-feeds
   '("https://grandmabuildsherhouse.com/feed/" "https://grandmabuildsherhouse.com"
 ...
 '(package-selected-packages
   '(slime elfeed-org zenburn-theme elfeed-goodies elfeed god-mode modus-themes parinfer-rust-mode project org simple-httpd weblorg htmlize elpher ox-gemini vterm emms treemacs desktop-environment org-static-blog exwm-x exwm inf-clojure clojure-mode yasnippet xkcd w3 solarized-theme rainbow-delimiters org-bullets lusty-explorer lua-mode forecast flx-ido expand-region company cdlatex bm auctex))
